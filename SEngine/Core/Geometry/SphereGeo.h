...
// 球生成参考了X_Jun第7章
class SpherePosGeo : public GeometryBase<VertexPos>
{
public:
    SpherePosGeo(float radius, UINT levels = 20, UINT slices = 20)
    {
        ...
        VertexPos vertexData(DirectX::XMFLOAT3(0.0f, radius, 0.0f));
        ...
        // 放入底端点
        vertexData = { DirectX::XMFLOAT3(0.0f, -radius, 0.0f) };
        vertices[vIndex++] = vertexData;
