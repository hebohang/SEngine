...
// 球生成参考了X_Jun第7章
class SphereGeo : public GeometryBase<VertexPosColor>
{
public:
	SphereGeo(float radius, UINT levels, UINT slices, const DirectX::XMFLOAT4& color)
	{
        ...
        for (UINT i = 1; i < levels; ++i)
        {
            ...
            for (UINT j = 0; j <= slices; ++j)
            {
                ...
                DirectX::XMFLOAT3 pos = DirectX::XMFLOAT3(x, y, z), normal;
                DirectX::XMStoreFloat3(&normal, DirectX::XMVector3Normalize(XMLoadFloat3(&pos)));
